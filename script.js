...
//     if(i<=4){
//      let imageTag = document.createElement('img');
//      imageTag.className =  imagesClassNames[counter++];
//      robotContainer.append(imageTag);
//     }
//     else if(i == 5){
//         let randomIndex = Math.floor(Math.random()*imagesClassNames.length) // 0-4
//         let img6ClassName = imagesClassNames[randomIndex]
//         let imageTag = document.createElement('img');
